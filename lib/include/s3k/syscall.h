...
s3k_err_t s3k_br_cap_derive(s3k_cidx_t src, s3k_cidx_t dst, s3k_cap_t new_cap);
s3k_err_t s3k_br_cap_revoke(s3k_cidx_t idx);

s3k_err_t s3k_br_pmp_load(s3k_cidx_t pmp_idx, s3k_pmp_slot_t pmp_slot);
s3k_err_t s3k_br_pmp_unload(s3k_cidx_t pmp_idx);
...
s3k_err_t s3k_br_try_cap_derive(s3k_cidx_t src, s3k_cidx_t dst,
				s3k_cap_t new_cap);
s3k_err_t s3k_br_try_cap_revoke(s3k_cidx_t idx);

s3k_err_t s3k_br_try_pmp_load(s3k_cidx_t pmp_idx, s3k_pmp_slot_t pmp_slot);
s3k_err_t s3k_br_try_pmp_unload(s3k_cidx_t pmp_idx);

s3k_err_t s3k_br_try_mon_suspend(s3k_cidx_t mon_idx, s3k_pid_t pid);
s3k_err_t s3k_br_try_mon_resume(s3k_cidx_t mon_idx, s3k_pid_t pid);
s3k_err_t s3k_br_try_mon_state_get(s3k_cidx_t mon_idx, s3k_pid_t pid,
				   s3k_state_t *state);
s3k_err_t s3k_br_try_mon_yield(s3k_cidx_t mon_idx, s3k_pid_t pid);
s3k_err_t s3k_br_try_mon_reg_read(s3k_cidx_t mon_idx, s3k_pid_t pid,
				  s3k_reg_t reg, uint64_t *val);
s3k_err_t s3k_br_try_mon_reg_write(s3k_cidx_t mon_idx, s3k_pid_t pid,
				   s3k_reg_t reg, uint64_t val);
