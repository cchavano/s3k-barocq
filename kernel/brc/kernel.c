...
struct kernel_state *u_vreg_write(struct kernel_state *, unsigned int,
				  unsigned long long);
unsigned long long u_cap_get_type(unsigned long long);
unsigned long long u_cap_mk_none(void);
unsigned long long u_cap_mk_time(unsigned long long, unsigned long long,
...
unsigned long long u_cap_mk_memory(unsigned long long, unsigned long long,
				   unsigned long long, unsigned long long,
				   unsigned long long, unsigned long long);
...
unsigned long long u_cap_mk_pmp(unsigned long long, unsigned long long,
				unsigned long long, unsigned long long);
...
unsigned long long u_cap_mk_monitor(unsigned long long, unsigned long long,
				    unsigned long long);
...
unsigned long long u_cap_monitor_set_bgn(unsigned long long,
					 unsigned long long);
unsigned long long u_cap_monitor_set_mrk(unsigned long long,
					 unsigned long long);
unsigned long long u_cap_monitor_set_end(unsigned long long,
					 unsigned long long);
unsigned long long u_cap_mk_channel(unsigned long long, unsigned long long,
				    unsigned long long);
...
unsigned long long u_cap_channel_set_bgn(unsigned long long,
					 unsigned long long);
unsigned long long u_cap_channel_set_mrk(unsigned long long,
					 unsigned long long);
unsigned long long u_cap_channel_set_end(unsigned long long,
					 unsigned long long);
unsigned long long u_cap_mk_socket(unsigned long long, unsigned long long,
				   unsigned long long, unsigned long long);
...
unsigned long long u_cap_socket_set_mode(unsigned long long,
					 unsigned long long);
unsigned long long u_cap_socket_set_perm(unsigned long long,
					 unsigned long long);
unsigned long long u_cap_socket_set_chan(unsigned long long,
					 unsigned long long);
...
struct kernel_state *u_ctable_set_cap(struct kernel_state *, unsigned int,
				      unsigned long long);
struct kernel_state *u_ctable_set_next(struct kernel_state *, unsigned int,
				       unsigned int);
struct kernel_state *u_ctable_set_prev(struct kernel_state *, unsigned int,
				       unsigned int);
struct kernel_state *u_ctable_move_cap(struct kernel_state *, unsigned int,
				       unsigned int);
struct kernel_state *u_ctable_delete_cap(struct kernel_state *, unsigned int);
struct kernel_state *u_ctable_insert_cap(struct kernel_state *, unsigned int,
...
struct kernel_state *u_cap_derive_memory(struct kernel_state *, unsigned int,
...
struct kernel_state *u_cap_derive_pmp(struct kernel_state *, unsigned int,
				      unsigned int, unsigned long long);
struct kernel_state *u_cap_read(struct kernel_state *, unsigned int);
struct kernel_state *u_cap_move(struct kernel_state *, unsigned int,
				unsigned int);
struct kernel_state *u_cap_delete(struct kernel_state *, unsigned int);
struct kernel_state *u_cap_derive(struct kernel_state *, unsigned int,
				  unsigned int, unsigned long long);
...
struct kernel_state *u_vreg_write(struct kernel_state *$p_ks,
				  unsigned int $p_rid, unsigned long long $p_v)
{
...
unsigned long long u_cap_mk_time(unsigned long long $p_hart,
				 unsigned long long $p_bgn,
				 unsigned long long $p_mrk,
...
unsigned long long u_cap_time_set_hart(unsigned long long $p_cap,
				       unsigned long long $p_v)
{
	return $p_cap & ~65280LL | $p_v << 8LL;
}

unsigned long long u_cap_time_set_bgn(unsigned long long $p_cap,
				      unsigned long long $p_v)
{
	return $p_cap & ~4294901760LL | $p_v << 16LL;
}

unsigned long long u_cap_time_set_mrk(unsigned long long $p_cap,
				      unsigned long long $p_v)
{
	return $p_cap & ~281470681743360LL | $p_v << 32LL;
}

unsigned long long u_cap_time_set_end(unsigned long long $p_cap,
				      unsigned long long $p_v)
{
...
unsigned long long
u_cap_mk_memory(unsigned long long $p_rwx, unsigned long long $p_lck,
		unsigned long long $p_tag, unsigned long long $p_bgn,
		unsigned long long $p_mrk, unsigned long long $p_end)
{
...
unsigned long long u_cap_memory_set_rwx(unsigned long long $p_cap,
					unsigned long long $p_v)
{
...
unsigned long long u_cap_memory_set_tag(unsigned long long $p_cap,
					unsigned long long $p_v)
{
	return $p_cap & ~65280LL | $p_v << 8LL;
}

unsigned long long u_cap_memory_set_bgn(unsigned long long $p_cap,
					unsigned long long $p_v)
{
	return $p_cap & ~4294901760LL | $p_v << 16LL;
}

unsigned long long u_cap_memory_set_mrk(unsigned long long $p_cap,
					unsigned long long $p_v)
{
	return $p_cap & ~281470681743360LL | $p_v << 32LL;
}

unsigned long long u_cap_memory_set_end(unsigned long long $p_cap,
					unsigned long long $p_v)
{
	return $p_cap & ~-281474976710656LL | $p_v << 48LL;
}

unsigned long long u_cap_mk_pmp(unsigned long long $p_rwx,
				unsigned long long $p_used,
				unsigned long long $p_slot,
...
unsigned long long u_cap_pmp_set_rwx(unsigned long long $p_cap,
				     unsigned long long $p_v)
{
	return $p_cap & ~112LL | $p_v << 4LL;
}
...
unsigned long long u_cap_pmp_set_slot(unsigned long long $p_cap,
				      unsigned long long $p_v)
{
	return $p_cap & ~65280LL | $p_v << 8LL;
}

unsigned long long u_cap_pmp_set_addr(unsigned long long $p_cap,
				      unsigned long long $p_v)
{
	return $p_cap & ~-65536LL | $p_v << 16LL;
}

unsigned long long u_cap_mk_monitor(unsigned long long $p_bgn,
				    unsigned long long $p_mrk,
				    unsigned long long $p_end)
{
	return u_CAPTY_MONITOR | $p_end << 48LL | $p_mrk << 32LL
	       | $p_bgn << 16LL;
}
...
unsigned long long u_cap_monitor_set_bgn(unsigned long long $p_cap,
					 unsigned long long $p_v)
{
	return $p_cap & ~4294901760LL | $p_v << 16LL;
}

unsigned long long u_cap_monitor_set_mrk(unsigned long long $p_cap,
					 unsigned long long $p_v)
{
	return $p_cap & ~281470681743360LL | $p_v << 32LL;
}

unsigned long long u_cap_monitor_set_end(unsigned long long $p_cap,
					 unsigned long long $p_v)
{
	return $p_cap & ~-281474976710656LL | $p_v << 48LL;
}

unsigned long long u_cap_mk_channel(unsigned long long $p_bgn,
				    unsigned long long $p_mrk,
				    unsigned long long $p_end)
{
	return u_CAPTY_CHANNEL | $p_end << 48LL | $p_mrk << 32LL
	       | $p_bgn << 16LL;
}
...
unsigned long long u_cap_channel_set_bgn(unsigned long long $p_cap,
					 unsigned long long $p_v)
{
	return $p_cap & ~4294901760LL | $p_v << 16LL;
}

unsigned long long u_cap_channel_set_mrk(unsigned long long $p_cap,
					 unsigned long long $p_v)
{
	return $p_cap & ~281470681743360LL | $p_v << 32LL;
}

unsigned long long u_cap_channel_set_end(unsigned long long $p_cap,
					 unsigned long long $p_v)
{
	return $p_cap & ~-281474976710656LL | $p_v << 48LL;
}

unsigned long long u_cap_mk_socket(unsigned long long $p_mode,
				   unsigned long long $p_perm,
				   unsigned long long $p_chan,
				   unsigned long long $p_tag)
{
	return u_CAPTY_SOCKET | $p_tag << 32LL | $p_chan << 16LL
	       | $p_perm << 8LL | $p_mode << 4LL;
}
...
unsigned long long u_cap_socket_set_mode(unsigned long long $p_cap,
					 unsigned long long $p_v)
{
	return $p_cap & ~240LL | $p_v << 4LL;
}

unsigned long long u_cap_socket_set_perm(unsigned long long $p_cap,
					 unsigned long long $p_v)
{
	return $p_cap & ~65280LL | $p_v << 8LL;
}

unsigned long long u_cap_socket_set_chan(unsigned long long $p_cap,
					 unsigned long long $p_v)
{
	return $p_cap & ~4294901760LL | $p_v << 16LL;
}

unsigned long long u_cap_socket_set_tag(unsigned long long $p_cap,
					unsigned long long $p_v)
{
...
struct kernel_state *u_ctable_set_cap(struct kernel_state *$p_ks,
				      unsigned int $p_cid,
				      unsigned long long $p_cap)
{
...
struct kernel_state *u_ctable_set_next(struct kernel_state *$p_ks,
				       unsigned int $p_cid,
				       unsigned int $p_nextid)
{
...
struct kernel_state *u_ctable_set_prev(struct kernel_state *$p_ks,
				       unsigned int $p_cid,
				       unsigned int $p_previd)
{
...
struct kernel_state *u_ctable_move_cap(struct kernel_state *$p_ks,
...
struct kernel_state *u_ctable_delete_cap(struct kernel_state *$p_ks,
					 unsigned int $p_cid)
{
...
struct kernel_state *u_ctable_insert_cap(struct kernel_state *$p_ks,
					 unsigned int $p_cid,
					 unsigned long long $p_cap,
					 unsigned int $p_previd)
{
...
unsigned long long u_tag_block_to_addr(unsigned long long $p_tag,
				       unsigned long long $p_block)
{
	return ($p_tag << u_MAX_BLOCK_SIZE) + ($p_block << u_MIN_BLOCK_SIZE);
}

struct kernel_state *u_cap_delete_memory(struct kernel_state *$p_ks,
					 unsigned int $p_cid)
{
	register struct kernel_state *$u_ks;
	register struct kernel_state *$i0;
...
struct kernel_state *u_cap_revoke_memory(struct kernel_state *$p_ks,
					 unsigned int $p_parent)
{
...
struct kernel_state *u_cap_derive_memory(struct kernel_state *$p_ks,
					 unsigned int $p_src,
					 unsigned int $p_dst,
					 unsigned long long $p_ncap)
{
	...
	if ($b15) {
		...
		if ($b7) {
			...
			$u_ks = u_ctable_set_cap($p_ks, $p_src, $u_cap);
			$u_ks = u_ctable_insert_cap($u_ks, $p_dst, $p_ncap,
						    $p_src);
			(*$u_ks).errcode = u_SUCCESS;
			$i1 = $u_ks;
			return $i1;
...
struct kernel_state *u_cap_delete_pmp(struct kernel_state *$p_ks,
				      unsigned int $p_cid)
{
	register unsigned long long $u_cap;
	register _Bool $b2;
...
struct kernel_state *u_cap_derive_pmp(struct kernel_state *$p_ks,
				      unsigned int $p_src, unsigned int $p_dst,
				      unsigned long long $p_ncap)
{
	register struct kernel_state *$i0;
...
struct kernel_state *u_cap_move(struct kernel_state *$p_ks, unsigned int $p_src,
				unsigned int $p_dst)
{
	register _Bool $b2;
	register struct kernel_state *$i0;
...
struct kernel_state *u_cap_delete(struct kernel_state *$p_ks,
				  unsigned int $p_cid)
{
	register _Bool $b1;
	register struct kernel_state *$i0;
...
struct kernel_state *u_cap_derive(struct kernel_state *$p_ks,
				  unsigned int $p_src, unsigned int $p_dst,
				  unsigned long long $p_ncap)
{
	register _Bool $b3;
	...
	if ($b3) {
		...
		if ($b1) {
			...
			$u_cap_type = u_cap_get_type($b0);
			if ($u_cap_type == u_CAPTY_MEMORY) {
				$i2 = u_cap_derive_memory($p_ks, $p_src, $p_dst,
							  $p_ncap);
				return $i2;
			} else {
				if ($u_cap_type == u_CAPTY_PMP) {
					$i3 = u_cap_derive_pmp($p_ks, $p_src,
							       $p_dst, $p_ncap);
					return $i3;
				} else {
					(*$p_ks).errcode
					    = u_ERR_INVALID_CAPABILITY;
					$i4 = $p_ks;
					return $i4;
				}
			}
